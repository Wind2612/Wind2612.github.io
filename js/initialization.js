...
function createProduct() {
    if (localStorage.getItem('products') == null) {
        ...
        },
        {
            ...
            img: './assets/img/products/tra-sua-mat-cha.jpg',
            category: 'Nước uống',
            price: 20.000,
            desc: 'Hương Matcha đậm đà kết hợp cùng bột sữa không béo tiện lợi, tạo nên hương vị tươi mát, đậm chất thiên nhiên, Sản phẩm được chiết xuất dưới dạng bột, dễ dàng mang đi, ứng dụng mọi lúc mọi nơi. Sản phẩm có thể dùng nóng hoặc đá tùy ý thích. Nhớ mua ngay vị trà “Quốc dân” này nhé !'
        },
        ]
